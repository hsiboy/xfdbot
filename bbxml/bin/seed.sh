#!/bin/sh
/opt/bbxml/bin/bbxml2 /opt/bbxml/bin/setup.xml
/opt/bbxml/bin/bbtime
/opt/bbxmlnewsfeed/bbnewsfetch http://cruise:cruise@go.gen.tradermedia.net/go/cctray.xml P | /opt/bbxml/bin/bbxml2
